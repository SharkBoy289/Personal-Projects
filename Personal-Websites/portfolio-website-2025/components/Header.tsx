    ...
    <header className="fixed inset-x-0 top-0 z-50 bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/40 dark:bg-neutral-900/70 dark:supports-[backdrop-filter]:bg-neutral-900/40">
      <nav className="mx-auto flex max-w-5xl items-center justify-between p-4">
        ...
        <div className="flex items-center gap-2">
          <ThemeToggle />
          <button
            className="rounded p-2 text-black transition-colors hover:bg-amber-100 sm:hidden dark:text-neutral-100 dark:hover:bg-neutral-800"
            onClick={() => setOpen((v) => !v)}
          ...
          >
            <li>
              <Link
                href="/about"
                className="relative block rounded px-3 py-2 text-black transition-colors hover:bg-amber-100 hover:text-amber-700 after:absolute after:left-0 after:-bottom-1 after:h-0.5 after:w-0 after:bg-gradient-to-r from-blue-500 to-purple-500 after:transition-all after:duration-300 hover:after:w-full dark:text-neutral-100 dark:hover:bg-neutral-800 dark:hover:text-amber-300"
              >
                About Me
              </Link>
            </li>
